...
uint32_t downlink_ind = 0;
int32_t downlink_failed = 0;
...
void HT_API_setDownlinkCounter(uint32_t value) {
	downlink_counter = value;
}

uint32_t HT_API_getDownlinkCounter(void) {
	return downlink_counter;
}

void HT_API_setInd(uint32_t value) {
	downlink_ind = value;
}

uint32_t HT_API_getInd(void) {
	return downlink_ind;
}

void HT_API_setDownlinkFailed(int32_t value) {
	downlink_failed = value;
}

int32_t HT_API_getDownlinkFailed(void) {
