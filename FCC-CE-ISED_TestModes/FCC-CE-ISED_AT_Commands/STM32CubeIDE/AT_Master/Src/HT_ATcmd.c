...
static char AT_continuous_wave_str[] = {"CW"};
static char AT_stop_continuous_wave_str[] = {"STPCW"};
static char AT_single_tx_str[] = {"SINGLETX"};
static char AT_tx_test_str[] = {"TXTEST"};
static char AT_cfgrx_str[] = {"CFGRX"};
static char AT_rx_test_str[] = {"RXTEST"};
static char AT_rx_per_str[] = {"RXPER"};
static char AT_setTest_str[] = {"SETTEST"};
static char AT_startFrequencyHop_str[] = {"FREQHOP"};
...
AT_cmdStruct AT_checkCmdString(char *cmdStr) {
	...
	if(!strncmp(cmdStr, AT_send_str, strlen(AT_send_str))) {
		...
		status.AT_err = ERR_NONE;
	} else if(!strncmp(cmdStr, AT_continuous_wave_str, strlen(AT_continuous_wave_str))) {
		status.AT_type = AT_sigfox;
		status.AT_sigfoxCmd = AT_continuous_wave;
		status.AT_err = ERR_NONE;
	} else if(!strncmp(cmdStr, AT_stop_continuous_wave_str, strlen(AT_stop_continuous_wave_str))) {
		status.AT_type = AT_sigfox;
		status.AT_sigfoxCmd = AT_stop_continuous_wave;
		status.AT_err = ERR_NONE;
	} else if(!strncmp(cmdStr, AT_tx_test_str, strlen(AT_tx_test_str))) {
		status.AT_type = AT_sigfox;
		status.AT_sigfoxCmd = AT_tx_test;
		status.AT_err = ERR_NONE;
	} else if(!strncmp(cmdStr, AT_cfgrx_str, strlen(AT_cfgrx_str))) {
		status.AT_type = AT_sigfox;
		status.AT_sigfoxCmd = AT_cfgrx;
		status.AT_err = ERR_NONE;
	} else if(!strncmp(cmdStr, AT_rx_test_str, strlen(AT_rx_test_str))) {
		status.AT_type = AT_sigfox;
		status.AT_sigfoxCmd = AT_rx_test;
		status.AT_err = ERR_NONE;
	} else if(!strncmp(cmdStr, AT_rx_per_str, strlen(AT_rx_per_str))) {
		status.AT_type = AT_sigfox;
		status.AT_sigfoxCmd = AT_rx_per;
		status.AT_err = ERR_NONE;
	} else if(!strncmp(cmdStr, AT_single_tx_str, strlen(AT_single_tx_str))) {
		status.AT_type = AT_sigfox;
		status.AT_sigfoxCmd = AT_single_tx;
		status.AT_err = ERR_NONE;
	} else if(!strncmp(cmdStr, AT_setTest_str, strlen(AT_setTest_str))) {
		status.AT_type = AT_sigfox;
		status.AT_sigfoxCmd = AT_setTest_tx;
		status.AT_err = ERR_NONE;
	} else if(!strncmp(cmdStr, AT_startFrequencyHop_str, strlen(AT_startFrequencyHop_str))) {
		status.AT_type = AT_sigfox;
		status.AT_sigfoxCmd = AT_startFrequencyHop;
		status.AT_err = ERR_NONE;
	} else {
